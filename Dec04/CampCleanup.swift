...
func findOverlap(pair: [String]) -> Bool {
    ...
    // If Section A starting number is less than or equal to the ending number of Section B
    // Second condition is the same but reversed (Section B starting number)
